...
openssl req -new -newkey rsa:4096 -days 365 -nodes -x509 -subj "/C=BR/ST=SC/L=Florianopolis/O=Softplan/CN=localhost" -keyout /etc/apache2/ssl/apache.key  -out /etc/apache2/ssl/apache.crt
